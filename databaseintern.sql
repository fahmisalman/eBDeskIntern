...
MySQL - 10.1.22-MariaDB : Database - ebdesk_intern
*********************************************************************
*/
...
CREATE TABLE `percentage` (
  ...
  `percentage_1` int(11) NOT NULL,
  `percentage_2` int(11) NOT NULL,
  `percentage_3` int(11) NOT NULL,
  `percentage_4` int(11) NOT NULL,
  `id_percentage` int(11) DEFAULT NULL,
  `percentage_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_project` (`id_project`),
  KEY `FK4oia5bc2ss130kr6fo9jn5ofb` (`id_percentage`),
  KEY `FKfhtkfwll5cak29amybs9vobum` (`percentage_id`),
  CONSTRAINT `FK4oia5bc2ss130kr6fo9jn5ofb` FOREIGN KEY (`id_percentage`) REFERENCES `percentage` (`id_project`),
  CONSTRAINT `FKanrhyqp3ftupqnyv93besmtr` FOREIGN KEY (`id_project`) REFERENCES `project` (`id`),
  CONSTRAINT `FKfhtkfwll5cak29amybs9vobum` FOREIGN KEY (`percentage_id`) REFERENCES `percentage` (`id_project`),
  CONSTRAINT `percentage_ibfk_2` FOREIGN KEY (`id_project`) REFERENCES `project` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `percentage` */

insert  into `percentage`(`id`,`id_project`,`percentage_1`,`percentage_2`,`percentage_3`,`percentage_4`,`id_percentage`,`percentage_id`) values 
(1,29,30,20,40,10,NULL,NULL),
(2,32,30,60,5,5,NULL,NULL);
...
insert  into `project`(`id`,`name`,`status`,`price`,`size`,`time`,`start_time`,`current`) values 
(29,'Project Beneran',1,5000000,10,'1 bulan','2006-06-17',1),
(32,'Project Ketiga',1,5000000,3,'2 bulan','2007-06-17',3);
...
insert  into `project_skill`(`id_project`,`id_skill`) values 
(29,3),
(29,4);
...
insert  into `user`(`id`,`email`,`password`,`first_name`,`last_name`,`phone`,`role`,`totalproject`,`totalstar`,`ongoingproject`,`status`,`division_id`) values 
(7,'adhikagunadarma@gmail.com','$2a$10$6QHOzLsOhp6wGnwNUJz6oO/gzv16jEEfjGfc7vA5jn3coCC7lJ5pe','Adhika','Gunadarma','089690907891',1,0,0,0,0,1),
(8,'mariochrist@gmail.com','$2a$10$v2/POWc814C.t7QhTt.FEOPYZwKq8nWihvaUNa4zY2nmORc58nHpG','Mario','Christ','012312312',3,0,0,0,0,1),
(9,'levina022@gmail.com','$2a$10$uL7hq95gFZMfb20D3HB9qe2CntaZzFAP7ZSXqEUPOSz9i5HTDfL1G','Levina M','Mulia','0912768123751',3,0,0,0,0,2),
(10,'skolastikasyenna@gmail.com','$2a$10$VS4j1/Kwq5amtrYuPyrbbeNwBg68kYjo8syQ/EsVzFH38VGY4kyN6','Skolastika ','Syenna','012313914',3,0,0,0,0,NULL),
(11,'basukiahok@gmail.com','$2a$10$Tjf0FMNgNJn2FDeCKG65s.5fm8xvE7K2XQiY.w3iBtMXgZVYG2Vb2','Basuki','Ahok','131212312312312',3,0,0,0,0,NULL),
(13,'naufalyai@gmail.com','$2a$10$VskmgbbX2oTkI2dWoF3h2uLYrmw.hcMcR7lrgebUXjCt9QRMyYUgi','Naufal','Dzaky','082240204498',1,0,0,0,0,NULL);
...
insert  into `user_project`(`id_user`,`id_project`,`rate`,`roles`) values 
(8,29,0,1),
(8,32,0,2),
(10,32,0,1),
(11,32,0,2);
...
insert  into `user_skill`(`id_user`,`id_skill`) values 
(7,1),
(7,2),
(7,3),
(8,1),
